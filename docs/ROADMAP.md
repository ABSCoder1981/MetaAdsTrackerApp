...
| 9 | Dec 7 – Dec 18, 2026 | MVP | Admin/Role Mgmt + Audit Logs (Epics J, K) | Settings + Members + Audit Log live; "invite by email" scoped to "add by email" pending custom SMTP (see `DEVELOPMENT_PLAN.md` Epic J) |
